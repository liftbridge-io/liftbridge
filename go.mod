...
require (
	...
	github.com/liftbridge-io/go-liftbridge/v2 v2.0.2-0.20200925212109-d8d35de2d115
	github.com/liftbridge-io/liftbridge-api v1.1.1-0.20200925184350-33638578d994
