...
require (
	...
	github.com/liftbridge-io/go-liftbridge v1.0.0-beta.0.20200421175653-542048b854b5
	github.com/liftbridge-io/liftbridge-api v1.0.0-beta.0.20200421175021-4ec4f58b0b9e
