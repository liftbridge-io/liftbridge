...
require (
	...
	github.com/liftbridge-io/go-liftbridge/v2 v2.2.1-0.20220120230937-d3363a444f5d
	github.com/liftbridge-io/liftbridge-api v1.7.1-0.20220111235147-44a8787763ad
