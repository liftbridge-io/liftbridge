...
require (
	...
	github.com/liftbridge-io/go-liftbridge/v2 v2.0.2-0.20200925174817-2617a1d8e6f7
	github.com/liftbridge-io/liftbridge-api v1.1.1-0.20200924210717-4ee8bde00417
