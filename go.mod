...
require (
	...
	github.com/liftbridge-io/go-liftbridge/v2 v2.0.2-0.20200916170438-ba85eaced251
	github.com/liftbridge-io/liftbridge-api v1.1.1-0.20200911220528-1beb4c39914a
