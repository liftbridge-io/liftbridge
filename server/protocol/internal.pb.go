...
type CustomStreamConfig struct {
	...
	RetentionMaxAge      string `protobuf:"bytes,3,opt,name=RetentionMaxAge,proto3" json:"RetentionMaxAge,omitempty"`
	CleanerInterval      string `protobuf:"bytes,4,opt,name=CleanerInterval,proto3" json:"CleanerInterval,omitempty"`
	SegmentMaxBytes      int64  `protobuf:"varint,5,opt,name=SegmentMaxBytes,proto3" json:"SegmentMaxBytes,omitempty"`
	SegmentMaxAge        string `protobuf:"bytes,6,opt,name=SegmentMaxAge,proto3" json:"SegmentMaxAge,omitempty"`
...
func (m *CustomStreamConfig) GetRetentionMaxAge() string {
	if m != nil {
...
func (m *CustomStreamConfig) GetCleanerInterval() string {
	if m != nil {
...
func (m *CustomStreamConfig) GetSegmentMaxAge() string {
	if m != nil {
...
func (m *CustomStreamConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RetentionMaxAge) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintInternal(dAtA, i, uint64(len(m.RetentionMaxAge)))
		i += copy(dAtA[i:], m.RetentionMaxAge)
	}
	if len(m.CleanerInterval) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintInternal(dAtA, i, uint64(len(m.CleanerInterval)))
		i += copy(dAtA[i:], m.CleanerInterval)
	}
	...
	if len(m.SegmentMaxAge) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintInternal(dAtA, i, uint64(len(m.SegmentMaxAge)))
		i += copy(dAtA[i:], m.SegmentMaxAge)
	}
...
func (m *CustomStreamConfig) Size() (n int) {
	...
	l = len(m.RetentionMaxAge)
	if l > 0 {
		n += 1 + l + sovInternal(uint64(l))
	}
	l = len(m.CleanerInterval)
	if l > 0 {
		n += 1 + l + sovInternal(uint64(l))
	}
	if m.SegmentMaxBytes != 0 {
...
func (m *CustomStreamConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.RetentionMaxAge = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.CleanerInterval = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
		...
		case 6:
			...
			m.SegmentMaxAge = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 0 {
...
var fileDescriptorInternal = []byte{
	...
	,
}
